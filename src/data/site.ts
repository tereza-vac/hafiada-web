...
export const event = {
  ...
  applicationDeadline: "25. 8. 2026",
  gps: "49.6393886N, 18.7220669E",
  navAddress: "Bystřice 848",
  addressFull: "Areál před bazénem, Bystřice 848, 739 95 Bystřice",
  mapUrl: "https://www.google.com/maps/search/?api=1&query=49.6393886,18.7220669",
  mapUrlMapy: "https://mapy.cz/zakladni?q=49.6393886%2C18.7220669&source=coor&id=18.7220669%2C49.6393886",
...
export const payment = {
  ...
  haficross: {
    ...
    instructions: [
      ...
      "Startovné musí být připsáno na účet nejpozději 25. 8. 2026 – na pozdější reklamace nebude brán zřetel.",
...
export const partners: Partner[] = [
  ...
  { name: "Bajusz s.r.o.", url: "https://www.bajusz.cz/" },
  { name: "Kara kebab – Bystřice" },
  { name: "Prodejna Katka Nýdek", url: "https://www.katkanydek.cz/" },
  { name: "ZKO Třinec", url: "https://zko-trinec.wbs.cz/" },
  { name: "Sbor dobrovolných hasičů Bystřice", url: "https://www.hasicibystrice.cz/" },
